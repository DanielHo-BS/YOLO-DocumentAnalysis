...
def detect(save_img=False):
    ...
    colors = [(0, 0, 255), (0, 255, 0), (255, 0, 0), (255, 255, 0), (255, 0, 255)] + [[random.randint(0, 255) for _ in range(3)] for _ in names] #1110 固定色彩
    ...
    average = (time.time() - t0) / len(dataset)
    print(f'{average}s per image(frame)')
