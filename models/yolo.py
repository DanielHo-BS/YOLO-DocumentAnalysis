...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in {
            ...
            RepVGG, RCSOSA,  Conv_ATT,  RepConv,
            SwinTransformerBlock, STCSPA, STCSPB, STCSPC,
            SwinTransformer2Block, ST2CSPB
            }:
            c1, c2 = ch[f], args[0]
            ...
            args = [c1, c2, *args[1:]]
            if m in {
                BottleneckCSP, C1, C2, C2x, C3, C3TR, C3Ghost, C3x, SPPCSPC, RCSOSA,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='./cfg/yolov7_SwinV2.yaml', help='model.yaml')
